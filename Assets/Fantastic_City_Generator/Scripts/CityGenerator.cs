...
namespace FCG
{
    ...
    public class CityGenerator : MonoBehaviour
    {
        ...
        public Dictionary<Vector3, CityStreet> m_cityMap = new Dictionary<Vector3, CityStreet>();
        ...
        public void GenerateRoad(float mapWidth, float mapHeight)
        {
            ...
            while (m_minZ > -mapHeight * 0.5f)
            {
                ...
                while (posX < mapWidth * 0.5f)
                {
                    ...
                    if (index == 0 && towards == 0)
                    {
                        ...
                        m_cityMap.Add(initStreet.position, initStreet);
                    }
                    else
                    {
                        ...
                        m_cityMap.Add(lefRoad.position, lefRoad);
                        m_cityMap.Add(rightRoad.position, rightRoad);   
                    }
            ...
            while (m_maxZ < mapHeight * 0.5f)
            {
                ...
                while (posX < mapWidth * 0.5f)
                {
                    ...
                    else
                    {
                        ...
                        m_cityMap.Add(leftStreet.position, leftStreet);
                        m_cityMap.Add(rightStreet.position, rightStreet);   
                    }
            ...
            //创建路
            foreach (var kv in m_cityMap)
            {
                Instantiate(largeBlocks[Random.Range(0, largeBlocks.Length)], kv.Value.position, kv.Value.rotation, cityMaker.transform);
            }
        ...
        private float GetWith(GameObject building)
        {
           ...
           var meshFilter = building.transform.Find("House").GetChild(0).GetComponent<MeshFilter>();
           if (meshFilter)
           {
